...
<title>We are engineers - Giáo trình - bài giảng - ${tutorial.title }</title>
...
<meta property="og:description" content="${tutorial.shortDesc }" />
				...
				<div class="col-md-12">
					<div class="block">
						...
						<div class="portfolio-meta">
							<span> Tác giả: ${tutorial.author }</span>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="single-post">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="post-img">
						<img class="img-responsive" alt="" src="${tutorial.fullImage }">
					</div>
					<div class="post-content">${tutorial.fullDesc }</div>
				</div>
			</div>
		</div>
	</section>
