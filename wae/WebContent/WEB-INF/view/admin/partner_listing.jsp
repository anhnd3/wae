...
<title>WAE Tools - Partner Listing</title>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							Partner listing <a href="partner-form"><button type="button"
							...
							<table style="width: 100%"
								...
								<tbody>
									<c:forEach items="${partners }" var="tmpPartner">
										<tr>
											<td>${tmpPartner.id }</td>
											<td>${tmpPartner.name }</td>
											<td><img alt="228x114" src="${tmpPartner.thumbnail }"
												style="width: 100px; height: 50px;"></td>
											<c:if test="${tmpPartner.status == true }">
												<td><i class="fa fa-check"></i></td>
											</c:if>
											<c:if test="${tmpPartner.status == false }">
												<td><i class="fa fa-ban"></i></td>
											</c:if>
											<td><a href="partner-detail?id=${tmpPartner.id }"><i
													class="fa fa-edit"></i> </a>| <a
												onclick="return confirm('Do you want to delete partner: ${tmpPartner.name}?')"
												href="partner-delete?id=${tmpPartner.id }"><i
