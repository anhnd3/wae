...
<title>WAE Tools - User Listing</title>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							User listing <a href="user-form"><button type="button"
						...
						<div class="panel-body">
							<table style="width: 100%"
								...
								<tbody>
									<c:forEach items="${users }" var="tmpUser">
										<tr>
											<td>${tmpUser.id }</td>
											<td>${tmpUser.email }</td>
											<c:choose>
												<c:when test="${tmpUser.privilege == 1 }">
													<td>Mod</td>
												</c:when>
												<c:when test="${tmpUser.privilege == 2 }">
													<td>Admin</td>
												</c:when>
												<c:otherwise>
													<td>User</td>
											...
											<td><a
												href="user-detail?id=${tmpUser.id }&type=privilege"><i
													class="fa fa-edit"></i> </a> | <a
												href="user-detail?id=${tmpUser.id }"><i
													class="fa fa-key"></i> </a> | <a
												onclick="return confirm('Do you want to delete user: ${tmpUser.email}?')"
												href="user-delete?id=${tmpUser.id }"><i
