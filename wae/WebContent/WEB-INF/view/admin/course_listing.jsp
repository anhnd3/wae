...
<title>WAE Tools - Course Listing</title>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							Course listing <a href="course-form"><button type="button"
								...
								<tbody>
									<c:forEach items="${courses }" var="tmpCourse">
										<tr>
											...
											<td>${tmpCourse.teacher }</td>
											<c:if test="${tmpCourse.status == true }">
												<td><i class="fa fa-check"></i></td>
											</c:if>
											<c:if test="${tmpCourse.status == false }">
												<td><i class="fa fa-ban"></i></td>
											</c:if>
											<td><a href="course-detail?id=${tmpCourse.id }"><i
													class="fa fa-edit"></i> </a>| <a
												onclick="return confirm('Do you want to delete course: ${tmpCourse.title}?')"
												href="course-delete?id=${tmpCourse.id }"><i
