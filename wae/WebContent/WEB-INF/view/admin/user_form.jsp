				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form:form role="form" action="user-form-execute"
										modelAttribute="user" method="POST" acceptCharset="UTF-8">
										<div class="form-group col-lg-4">
											<label>Email</label>
											<form:input path="email" cssClass="form-control"
												placeholder="Email" autofocus="autofocus" required="true" />
										...
										<div class="form-group col-lg-4">
											...
											<form:select path="privilege" cssClass="form-control">
												<form:options items="${privileges }" itemValue="value"
													itemLabel="desc" />
											</form:select>
