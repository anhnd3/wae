...
<title>WAE Tools - Message Listing</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Message listing</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<table style="width: 100%"
								...
								<tbody>
									<c:forEach items="${messages }" var="tmpMessage">
										<tr>
											<td>${tmpMessage.id }</td>
											<td>${tmpMessage.name }</td>
											<td>${tmpMessage.email }</td>
											<td>${tmpMessage.subject }</td>
											<td><a href="message-detail?id=${tmpMessage.id }"><i
													class="fa fa-eye"></i> </a>| <a
												onclick="return confirm('Do you want to delete message: ${tmpMessage.subject}?')"
												href="message-delete?id=${tmpMessage.id }"><i
